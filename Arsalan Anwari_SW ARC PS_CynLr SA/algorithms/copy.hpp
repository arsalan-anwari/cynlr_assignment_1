...
namespace cynlr {
    ...
    void copy_tail_to_head(std::span<T> data, usize additional_back_offset){
    ...
    template<> void copy_tail_to_head<u8, 8u>(std::span<u8> data, usize additional_back_offset) {
